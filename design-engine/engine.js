...
"""`;
  ...
  const SB_LINT_RULES = [
    ...
    { re:/\b(pack|tube|box|product)\b[^.,;]{0,40}\b(glides?|gliding|slides?|sliding|floats?|floating|drifts?|transitions?|moves? (in|into|across)|bursts? (in|into)|pops? (in|into)|flies|flying)\b/i, f:['visual','motion'], msg:'the pack moving itself (glide/slide/float/fly-in) — the pack is ALWAYS static and already in place; the camera or environment moves, never the pack' },
