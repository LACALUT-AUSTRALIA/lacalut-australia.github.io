...
"""`;
  ...
  const SB_LINT_RULES = [
    ...
    { sq:true, re:/\b(gums(?! care)|gum ?line)\b/i, f:['visual','motion'], msg:'gums visually depicted — gums are NEVER shown on screen (uncanny); they live in the voiceover and captions only' },
