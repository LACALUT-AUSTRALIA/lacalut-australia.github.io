...
"""`;
  ...
  const SB_LINT_RULES = [
    ...
    { re:/\b(effective(ly)?|firms|firming|firmness|strengthens?|supports?|protect(s|ion|ive|ed)?|prevents?|fights?|combats?|repairs?|treat(s|ments?)?|cures?|heals?|regenerat\w*|clinically|proven)\b/i, f:['vo','text'], msg:'efficacy/therapeutic wording — cosmetic feel-language only ("feels firm", "cared-for")' },
    ...
    { re:/\b(gives?|giving|provides?|delivers?|restores?|brings?)\b[^.]{0,25}\bgums?\b[^.]{0,25}\b(firm\w*|strength|strong)\b/i, f:['vo','text'], msg:'physical firming-outcome claim — cosmetic feel-language only: "gums that FEEL firm"' },
    ...
    { re:/\b(pulsing|pulsating|throbbing|gritty|granular|lumpy|grainy)\b/i, f:['visual','motion'], msg:'unappetising/organic texture word — paste and product always look smooth, creamy and appealing; nothing pulses or throbs' },
    ...
    { re:/\bfirm\w*[ ,–-]+gums?\b/i, f:['vo','text'], msg:'bare firming-result phrase ("firm gums") — feel-language only: "gums that FEEL firm"' },
...
TYPE CHECKLIST (structural musts): Problem-Agitate-Solve = ~60% of runtime on the problem, product appears only after; Demo = the product physically IN ACTION in macro; Old-vs-New = BOTH sides actually shown in contrast; Transformation = an explicit BEFORE beat and AFTER beat (no before/after = fail, restructure); Social-Proof Mashup = rapid micro-beats each landing ONE captioned benefit; Brand Story = no people on camera, heritage narrative.
