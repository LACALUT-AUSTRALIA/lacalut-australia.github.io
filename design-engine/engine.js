...
- Keep the BADGE & ICON SYSTEM: benefit badges as rounded solid-colour pills with a white line-icon in a contrasting circle; trust badges as pills with a small icon (globe = countries, medal/ribbon = heritage/since-1925, shield = protection). Never flatten them into plain unstyled text. Keep a darkened scrim/shadow behind any headline over a bright or busy area.
